...
\begin{figure}[H]
    \centering
    \includegraphics[width=.45\textwidth]{../plots/dataset4/3d_points_and_splines_4.0_6.0.png}
    \includegraphics[width=.45\textwidth]{../plots/dataset4/3d_points_and_splines_5.0_0.0.png}
    \includegraphics[width=.45\textwidth]{../plots/dataset4/3d_points_and_splines_4.0_2.0.png}
    \includegraphics[width=.45\textwidth]{../plots/dataset4/3d_points_and_splines_6.0_1.0.png}
...
{\color{red} TODO: move these bulky plots to the final pages}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../plots/dataset4/reprojection_analysis_camera_0_before_ba_.png}
    \includegraphics[width=0.8\textwidth]{../plots/dataset4/reprojection_analysis_camera_0.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{../plots/dataset4/reprojection_analysis_camera_1_before_ba_.png}
    \includegraphics[width=0.6\textwidth]{../plots/dataset4/reprojection_analysis_camera_1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{imgs/online_no_ba_cam2.png}
    \includegraphics[width=0.6\textwidth]{imgs/online_ba_cam2.png}
...
The offline trajectory reconstruction is implemented as a set of Python scripts that can be run from the command line
