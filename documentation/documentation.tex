...
\begin{figure}[H]
    ...
    \includegraphics[width=.45\textwidth]{../plots/dataset4/Extension_to_splines_it4_6.0_2.0.png}
    \includegraphics[width=.45\textwidth]{../plots/dataset4/Extension_to_splines_it5_2.0_1.0.png}
...
The yolo detection has been implemented in a separate script, that can be run with the following command:

\begin{verbatim}
yolo_detection.py [-h] [--model MODEL] [--min_confidence MIN_CONFIDENCE] [--save_video] [--no_video] [--save_frames] dataset camera

YOLO-based drone tracking with comprehensive analysis.
...
options:
  ...
  --no_video            Don't save annotated video output
